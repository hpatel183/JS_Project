...
public class CleanReimbursement {
	...
	public CleanReimbursement() {
		super();
	}

	public CleanReimbursement(int id, double amount, Date submitted, Date resolved, String description, byte[] receipt,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CleanReimbursement other = (CleanReimbursement) obj;
	...
	public String toString() {
		return "CleanReimbursement [id=" + id + ", amount=" + amount + ", submitted=" + submitted + ", resolved="
